...
\begin{document}
    ...
    \begin{frame}{Introduction}{Motivation}
        Prominent Whisker Sensor Use Cases according to~\cite{s22072705}:
        \begin{itemize}
    ...
    \begin{frame}[c]{Related Work}{Robotic Whisker Sensors}
        \begin{itemize}
    ...
    \begin{frame}{Whisker Platform}
        \textbf{<The CAD drawing of the parts goes here>}
    ...
    \begin{frame}{Swiping Policy}{Control Algorithm}
        \begin{algorithm}[H]
            ...
            \begin{algorithmic}[1]
                ...
                \State \(\mathrm{midpoint\_spline.add\_keypoint}\big((\;^{\mathrm{w}}\boldsymbol{r}_{\mathrm{tip, r}}^{t} + \;^{\mathrm{w}}\boldsymbol{r}_{\mathrm{tip, l}}^{t}) / 2\big)\)
                ...
                \State \(\;^{\mathrm{w}}\boldsymbol{r}^{t} \gets \;^{\mathrm{w}}\boldsymbol{r}^{t+1} + \;^{\mathrm{w}}\boldsymbol{\tau}_{\mathrm{spline}}^{t} + \mathrm{pull_{total}}/2 \cdot \;^{\mathrm{w}}\boldsymbol{n}_{\mathrm{spline}}^{t}\)
