...
The target position is calculated as current position plus the weighted sum of the spline tangent and deflection “pull“ (Algorithm~\ref{alg:tunneling_policy}, lines 9--10 highlighted in green).
