...
class BodyMotionController:
    def __init__(
        self, *, total_v: float, control_rps: float, get_state: Callable[[], WorldState]
    ):
    ...
    def control(self, tgt_body_yaw_w: float) -> Control:
        ...
        body_vx_s = self.pid_wr0_yaw_w(-(self.tgt_defl - self._state.wr0_yaw_s))
        ...
        body_omega = self.pid_body_yaw_w(tgt_body_yaw_w - self._state.body_yaw_w)
